...
class ApproveServiceCentersPage extends StatelessWidget {
  ...
  Future<void> approveCenter(
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text("Service Center Approved")),
    );
  }

  Future<void> rejectCenter(
      BuildContext context, String uid) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text("Service Center Rejected")),
    );
  }
          ...
          child: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              ...
              if (!snapshot.hasData ||
                ...
                return const Center(
                    child: Text(
                        "No pending service center approvals."));
              }
